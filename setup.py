#!/usr/bin/env python
descr = """Python module to compute the COPACAR collective pairwise classification model for multi-way data analysis."""
...
URL = 'http://github.com/marinkaz/copacar'
LICENSE = 'GPLv2'
DOWNLOAD_URL = URL
PACKAGE_NAME = 'copacar'
EXTRA_INFO = dict(
    classifiers=[
